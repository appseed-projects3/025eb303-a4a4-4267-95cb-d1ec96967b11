...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-27 12:42`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/025eb303-a4a4-4267-95cb-d1ec96967b11.git
$ cd 025eb303-a4a4-4267-95cb-d1ec96967b11
```
